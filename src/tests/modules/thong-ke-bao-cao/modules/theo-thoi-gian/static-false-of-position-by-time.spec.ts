...
test('Test chart khi chưa có đủ thông tin(theo tháng) loại theo vị trí', async ({ page }) => {
    ...
    expect(linesAfterData).toBeLessThan(4); // Kiểm tra số lượng line lớn hơn 0 khi có dữ liệu
});

// Test case thống kê báo cáo theo thời gian không xuất hiện khi chưa chọn đủ thông tin
test('Test chart khi chưa có đủ thông tin(theo năm) loại theo vị trí', async ({ page }) => {
    await page.goto('http://localhost:3000/statistics');
...
// Test case thống kê báo cáo theo thời gian không xuất hiện khi chưa chọn đủ thông tin
test('Test chart khi chưa có đủ thông tin(theo quý) loại loại theo vị trí', async ({ page }) => {
    await page.goto('http://localhost:3000/statistics');
