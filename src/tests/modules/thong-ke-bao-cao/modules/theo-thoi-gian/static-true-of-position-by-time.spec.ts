...
test('Test chart có hiện khi chọn đủ thông tin(theo tháng) loại theo vị trí', async ({ page }) => {
...
// Test case thống kê báo cáo theo thời gian có xuất hiện
test('Test chart có hiện khi chọn đủ thông tin(theo năm) loại theo vị trí', async ({ page }) => {
    await page.goto('http://localhost:3000/statistics');
...
// Test case thống kê báo cáo theo thời gian có xuất hiện
test('Test chart có hiện khi chọn đủ thông tin(theo quý) loại theo vị trí', async ({ page }) => {
    await page.goto('http://localhost:3000/statistics');
